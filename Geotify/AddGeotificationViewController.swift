...
//    
    delegate?.addGeotificationViewController(controller: self, radius: radius, identifier: identifier, note: note!, eventType: eventType)
    
    
    //get coordinate -> Xs timer, get avg
    //call create region of delegate
